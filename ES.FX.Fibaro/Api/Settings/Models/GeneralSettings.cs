...
namespace ES.FX.Fibaro.Api.Settings.Models
{
    internal class GeneralSettings : IGeneralSettings
    {
        ...
        [JsonConverter(typeof(ConcreteTypeConverter<CurrentVersion>))]
        public ICurrentVersion CurrentVersion { get; set; }

        [JsonProperty("installVersion")]
        [JsonConverter(typeof(ConcreteTypeConverter<InstallVersion>))]
        public IInstallVersion InstallVersion { get; set; }
