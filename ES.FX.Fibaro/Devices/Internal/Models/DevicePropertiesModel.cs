...
{
    internal class DevicePropertiesModel : IDevicePropertiesModel
    {
        [JsonProperty("armConditions", NullValueHandling = NullValueHandling.Ignore)]
        [JsonConverter(typeof(ConcreteTypeConverter<ArmConditionsModel>))]
        public IArmConditionsModel ArmConditions { get; set; }
        ...
        [JsonConverter(typeof(ConcreteTypeConverter<ParameterModel[]>))]
        ...
        [JsonConverter(typeof(ConcreteTypeConverter<FirmwareUpdateModel>))]
        public IFirmwareUpdateModel FirmwareUpdate { get; set; }
        ...
        [JsonConverter(typeof(ConcreteTypeConverter<IconModel>))]
        public IIconModel Icon { get; set; }
        ...
        public ICentralSceneSupportModel[] CentralSceneSupport { get; set; }
        ...
        [JsonConverter(typeof(ConcreteTypeConverter<RowModel[]>))]
        public IRowModel[] Rows { get; set; }
